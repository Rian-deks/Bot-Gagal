...
const instagram = 'https://instagram.com/raynz15'; 
const telegram = 'https://t.me/(blom ada)'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/(blom ada)';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@raynz15`)
})
